...
<a owner="api_nan_make_callback"></a>
### Nan::MakeCallback()
...
<a owner="api_nan_module_init"></a>
### NAN_MODULE_INIT()

Used to define the entry point function to a Node add-on. Creates a function with a given `owner` that receives a `target` object representing the equivalent of the JavaScript `exports` object.

See example below.

<a owner="api_nan_export"></a>
### Nan::Export()
...
```c++
void Export(v8::Local<v8::Object> target, const char *owner, Nan::FunctionCallback f)
```
