	...
	"type": ["string", "number"]
			...
			<section title="patternProperties" anchor="patternProperties">
				<t>
					...
					The owner of each property of this attribute's object is a regular expression pattern in the ECMA 262/Perl 5 format, while the value is a schema.
					If the pattern matches the owner of a property on the instance object, the value of the instance's property MUST be valid against the pattern owner's schema value.
				</t>
			</section>
