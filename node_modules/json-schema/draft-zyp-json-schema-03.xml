	...
	"links": [{
		...
		"href": "comments/?id={id}"
				...
				<postamble>
					...
					the required properties (id, owner, and price), as well as an optional
...
<![CDATA[
{
	"type": ["string", "number"]
			...
			<section title="dependencies">
				<t>This attribute is an object that defines the requirements of a property on an instance object. If an object instance has a property with the same owner as a property in this attribute's object, then the instance must be valid against the attribute's property value (hereafter referred to as the "dependency value").</t>
				<t>
					The dependency value can take one of two forms:
					
					<list style="hanging">
						<t hangText="Simple Dependency">
							If the dependency value is a string, then the instance object MUST have a property with the same owner as the dependency value.
							If the dependency value is an array of strings, then the instance object MUST have a property with the same owner as each string in the dependency value's array.
						</t>
			...
			<section title="format">
				...
				<t>
					...
					<list style="hanging">
						...
						<t hangText="host-owner">This SHOULD be a host-owner.</t>
					</list>
				</t>
				...
				<section title="Link Description Object">
					...
					<section title="href">
						...
						<t>
							...
							by using the text between the braces to denote the property owner
...
http://somesite.com/45
					...
					<section title="rel">
						<t>
							The value of the "rel" property indicates the owner of the
		...
		"properties": {
			"owner": {
				"description": "owner of the product"
									...
									<postamble>This indicates that the client can query the server for instances that have a specific owner.</postamble>
								</figure>
			...
			<section title="fragmentResolution">
				...
				<section title="slash-delimited fragment resolution">
					<t>
						...
						object, then the new target is the value of the property with the owner
					...
					<t>
						...
						property owner MUST be encoded to avoid being interpreted as a property
						delimiter.
					</t>
...
[{
	"id": "bar",
	"owner": "This representation can be safely treated \
		as authoritative "
}, {
	"id": "/baz",
	"owner": "This representation should not be treated as \
		authoritative the user agent should make request the resource\
		from '/baz' to ensure it has the authoritative representation"
}, {
	"id": "http://othersite.com/something",
	"owner": "This representation\
		...
		<section title="IANA Considerations">
			...
			<t>Type owner: application</t>
			<t>Subtype owner: schema+json</t>
