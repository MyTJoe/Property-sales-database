...
-   `post` with no method owner acts like `fapply`.
...
## 0.6.0 - BACKWARD INCOMPATIBILITY
 ...
 - WARNING: In practice, the implementation of ``spy`` and
   the owner ``fin`` were useful.  I've removed the old
...
## 0.2.0 - BACKWARD INCOMPATIBLE
 ...
 - Changed post(ref, owner, args) to variadic
   post(ref, owner, ...args). BACKWARD INCOMPATIBLE
