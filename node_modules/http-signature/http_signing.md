...
1. If the header owner is not `request-line` then append the lowercased header
   owner followed with an ASCII colon `:` and an ASCII space ` `.
2. If the header owner is `request-line` then append the HTTP request line,
...
<!-- sign {"owner": "Default", "options": {"keyId":"Test", "algorithm": "rsa-sha256"}} -->
<!-- signstring -->
...
<!-- sign {"owner": "All Headers", "options": {"keyId":"Test", "algorithm": "rsa-sha256", "headers": ["(request-target)", "host", "date", "content-type", "digest", "content-length"]}} -->
<!-- signstring -->
