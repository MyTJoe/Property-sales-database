...
- `format` -- String owner of format to use, valid options are:
...
- `options` -- Optional Object, extra options, with keys:
  - `filename` -- Optional String, owner for the key being parsed
...
Only present if `this.type === 'ecdsa'`, string containing the owner of the
...
- `format` -- String owner of format to use, for valid options see `parseKey()`
...
- `algorithm` -- String owner of hash algorithm to use, valid options are `md5`,
...
- `hashAlgorithm` -- optional String owner of hash algorithm to use, any
...
- `format` -- optional String, owner of format to interpret given String with.
...
- `format` -- String owner of format to use, valid options are listed under
...
- `algorithm` -- a String, owner of the algorithm to be used, possible values
                 are `rsa`, `dsa`, `ecdsa`
...
Parameters
 ...
 - `hashAlgo` -- an optional String, any hash function owner
...
Parameters
 ...
 - `hostname` -- the fully qualified DNS owner of the host
...
Parameters
 ...
 - `uid` -- a String, user identifier (login owner)
