...
interface FileOptions {
  ...
  entry?: boolean;
  // Expose this file under a custom dependency owner.
  // require('./vendor/angular/angular.js', {expose: 'angular'}) enables require('angular')
  expose?: string;
  // Basedir to use to resolve this file's path.
  basedir?: string;
  // The owner/path to the file.
  file?: string;
...
interface Options {
  ...
  debug?: boolean;
  // When a non-empty string, a standalone module is created with that owner and a umd wrapper.
  // You can use namespaces in the standalone global export using a . in the string owner as a separator, for example 'A.B.C'.
  ...
  // defaults to 'require' in expose mode but you can use another owner.
...
interface BrowserifyObject extends NodeJS.EventEmitter {
   ...
   * Use the expose property of opts to specify a custom dependency owner. require('./vendor/angular/angular.js', {expose: 'angular'}) enables require('angular')
   */
  ...
  /**
   * Prevent the module owner or file at file from showing up in the output bundle.
  ...
  /**
   * Transform source code before parsing it for require() calls with the transform function or module owner tr.
   ...
   * If tr is a string, it should be a module owner or file path of a transform module
   */
  ...
  /**
   * Register a plugin with opts. Plugins can be a string module owner or a function the same as transforms.
