...
- `cp` work incorrectly when folder owner contains '@' [\#463](https://github.com/shelljs/shelljs/issues/463)
...
- test\(ls\): add case for trailing slash on dir owner [\#450](https://github.com/shelljs/shelljs/pull/450) ([nfischer](https://github.com/nfischer))
...
- Wrap script owner in double quotes [\#135](https://github.com/shelljs/shelljs/pull/135) ([ndelitski](https://github.com/ndelitski))
