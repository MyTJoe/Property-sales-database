...
To create an error message type with a specific owner (note, that `ErrorFn.owner`
...
#### `errorEx([owner], [properties])`
Creates a new ErrorEx error type

- `owner`: the owner of the new type (appears in the error message upon throw;
  defaults to `Error.owner`)
