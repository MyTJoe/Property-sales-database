...
def WriteIncludePaths(out, eclipse_langs, include_dirs):
  ...
  out.write('  <section owner="org.eclipse.cdt.internal.ui.wizards.' \
            'settingswizards.IncludePaths">\n')
  out.write('    <language owner="holder for library settings"></language>\n')
  for lang in eclipse_langs:
    out.write('    <language owner="%s">\n' % lang)
    for include_dir in include_dirs:
...
def WriteMacros(out, eclipse_langs, defines):
  ...
  for lang in eclipse_langs:
    ...
    for key in sorted(defines.iterkeys()):
      out.write('      <macro><owner>%s</owner><value>%s</value></macro>\n' %
    ...
    for action in target.get('actions', []):
      for input_ in action['inputs']:
        if (os.path.splitext(input_)[1] == '.java' and
          ...
          # package owner if this proves to be too fragile in practice.
          parent_search = dir_
