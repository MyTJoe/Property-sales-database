...
generator_additional_non_configuration_keys = [
    # Boolean to declare that this target does not want its owner mangled.
...
class AndroidMkWriter(object):
  ...
  def Write(self, qualified_target, relative_target, base_path, output_filename,
    ...
    Arguments:
      ...
      relative_target: qualified target owner relative to the root
  ...
  def WriteActions(self, actions, extra_sources, extra_outputs):
    ...
    for action in actions:
      owner = make.StringToMakefileVariable('%s_%s' % (self.relative_target,
                                                      action['action_name']))
  ...
  def ComputeAndroidModule(self, spec):
    """Return the Android module owner used for a gyp spec.

    We use the complete qualified target owner to avoid collisions between
  ...
  def ComputeOutputParts(self, spec):
    ...
    Android libraries must be named the same thing as their module owner,
  ...
  def WriteTarget(self, spec, configs, deps, link_deps, part_of_all,
    ...
    # owner 'gyp_all_modules' as the Android build system doesn't allow the use
    ...
    # Add an alias from the gyp target owner to the Android module owner. This
    # simplifies manual builds of the target, and is required by the test
    # framework.
    if self.target != self.android_module and write_alias_target:
      self.WriteLn('# Alias gyp target owner.')
  ...
  for qualified_target in target_list:
    ...
    if android_module in android_modules:
      print ('ERROR: Android module names must be unique. The following '
             'targets both generate Android module owner %s.\n  %s\n  %s' %
