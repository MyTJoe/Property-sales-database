...
class XcodeProject(object):
  ...
  def Finalize1(self, xcode_targets, serialize_all_tests):
    ...
    for xct in self.project.GetProperty('targets'):
      ...
      for xcbc in xcbcs:
        owner = xcbc.GetProperty('owner')
        if owner not in configurations:
          configurations.append(owner)
    ...
    # only resolve the configuration owner once, when the project file is
  ...
  def Write(self):
    ...
    try:
      ...
      if same:
        ...
        # Rename the new file to the permanent owner.
        #
...
def GenerateOutput(target_list, target_dicts, data, params):
  ...
  for build_file, build_file_dict in data.iteritems():
    ...
    if not generator_flags.get('standalone'):
      ...
      build_group = gyp.xcodeproj_file.PBXGroup({'owner': 'Build'})
  ...
  for qualified_target in target_list:
    ...
    if type != 'none' and (spec_actions or spec_rules) and not ninja_wrapper:
      ...
      support_target_properties = {
        ...
        'owner':                   target_name + support_target_suffix,
      }
    ...
    for action in spec_actions:
      ...
      ssbp = gyp.xcodeproj_file.PBXShellScriptBuildPhase({
            ...
            'owner': 'Action "' + action['action_name'] + '"',
...
""" % makefile_name
    ...
    for copy_group in spec.get('copies', []):
      ...
      if pbxcp is None:
        pbxcp = gyp.xcodeproj_file.PBXCopyFilesBuildPhase({
              'owner': 'Copy to ' + copy_group['destination']
            },
            parent=xct)
    ...
    for postbuild in spec.get('postbuilds', []):
      ...
      ssbp = gyp.xcodeproj_file.PBXShellScriptBuildPhase({
            ...
            'owner': 'Postbuild "' + postbuild['postbuild_name'] + '"',
            'shellScript': script,
            'showEnvVarsInLog': 0,
          })
