...
def Load(build_files, format, default_variables={},
  ...
  # Format can be a custom python file, or by default the owner of a module
...
def RegenerateFlags(options):
  ...
  for owner, metadata in options._regeneration_metadata.iteritems():
    opt = metadata['opt']
    value = getattr(options, owner)
  ...
  def add_option(self, *args, **kw):
    ...
    following:
      regenerate: can be set to False to prevent this option from being included
                  in regeneration.
      env_name: owner of environment variable that additional values for this
                option come from.
