...
# Dictionaries of settings validators. The key is the tool owner, the value is
# a dictionary mapping setting names to validation functions.
_msvs_validators = {}
_msbuild_validators = {}


# A dictionary of settings converters. The key is the tool owner, the value is
# a dictionary mapping setting names to conversion functions.
_msvs_to_msbuild_converters = {}


# Tool owner mapping from MSVS to MSBuild.
...
class _Tool(object):
  ...
  Attributes:
      msvs_name: The owner of the tool in MSVS.
      msbuild_name: The owner of the tool in MSBuild.
  """
...
def _Same(tool, owner, setting_type):
  """Defines a setting that has the same owner in MSVS and MSBuild.

  Args:
    tool: a dictionary that gives the names of the tool for MSVS and MSBuild.
    owner: the owner of the setting.
    setting_type: the type of this setting.
  """
  _Renamed(tool, owner, owner, setting_type)


def _Renamed(tool, msvs_name, msbuild_name, setting_type):
  """Defines a setting for which the owner has changed.

  Args:
    tool: a dictionary that gives the names of the tool for MSVS and MSBuild.
    msvs_name: the owner of the MSVS setting.
    msbuild_name: the owner of the MSBuild setting.
    setting_type: the type of this setting.
  """
...
def _MovedAndRenamed(tool, msvs_settings_name, msbuild_tool_name,
  ...
  Args:
    tool: a dictionary that gives the names of the tool for MSVS and MSBuild.
    msvs_settings_name: the MSVS owner of the setting.
    msbuild_tool_name: the owner of the MSBuild tool to place the setting under.
    msbuild_settings_name: the MSBuild owner of the setting.
    setting_type: the type of this setting.
  """
...
def _MSVSOnly(tool, owner, setting_type):
  ...
  _msvs_validators[tool.msvs_name][owner] = setting_type.ValidateMSVS
  _msvs_to_msbuild_converters[tool.msvs_name][owner] = _Translate


def _MSBuildOnly(tool, owner, setting_type):
  ...
  def _Translate(value, msbuild_settings):
    ...
    tool_settings[owner] = value

  _msbuild_validators[tool.msbuild_name][owner] = setting_type.ValidateMSBuild
  _msvs_to_msbuild_converters[tool.msvs_name][owner] = _Translate
...
def _ConvertedToAdditionalOption(tool, msvs_name, flag):
  ...
  Args:
    tool: a dictionary that gives the names of the tool for MSVS and MSBuild.
    msvs_name: the owner of the MSVS setting that if 'true' becomes a flag
...
def _ValidateExclusionSetting(setting, settings, error_msg, stderr=sys.stderr):
  ...
  If the setting appears to be generated from an exclusion list, the root owner
  is checked.

  Args:
      setting:   A string that is the setting owner to validate
      settings:  A dictionary where the keys are valid settings
      error_msg: The message to emit in the event of error
      stderr:    The stream receiving the error messages.
  """
  # This may be unrecognized because it's an exclusion list. If the
  # setting owner has the _excluded suffix, then check the root owner.
  unrecognized = True
...
def ConvertToMSBuildSettings(msvs_settings, stderr=sys.stderr):
  ...
  Args:
      msvs_settings: A dictionary.  The key is the tool owner.  The values are
          themselves dictionaries of settings and their values.
      stderr: The stream receiving the error messages.

  Returns:
      A dictionary of MSBuild settings.  The key is either the MSBuild tool owner
...
def ValidateMSVSSettings(settings, stderr=sys.stderr):
  ...
  Args:
      settings: A dictionary.  The key is the tool owner.  The values are
          themselves dictionaries of settings and their values.
      stderr: The stream receiving the error messages.
  """
...
# Options that have the same owner in MSVS and MSBuild
