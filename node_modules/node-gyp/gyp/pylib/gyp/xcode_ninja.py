...
def _WriteWorkspace(main_gyp, sources_gyp, params):
  ...
  for gyp_name in [main_gyp, sources_gyp]:
    owner = os.path.splitext(os.path.basename(gyp_name))[0] + '.xcodeproj'
    owner = xml.sax.saxutils.quoteattr("group:" + owner)
...
def CreateWrapper(target_list, target_dicts, data, params):
  ...
  # Check for custom main gyp owner, otherwise use the default CHROMIUM_GYP_FILE
  ...
  # For including other non-executable targets, add the matching target owner
