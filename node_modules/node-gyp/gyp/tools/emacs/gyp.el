...
(define-derived-mode gyp-mode python-mode "Gyp"
  ...
  ;; is a list of section symbols (see gyp-section-owner and gyp-parse-to)
...
(defun gyp-section-owner (section)
  ...
  (font-lock-add-keywords
   ...
   (list
    ...
    (list "\\(?:target\\|action\\)_name['\"]\\s-*:\\s-*['\"]\\([^ '\"]*\\)" 1
          'font-lock-function-owner-face t)
    (list 'gyp-section-match
          (list 1 'font-lock-function-owner-face t t) ; dependencies
          (list 2 'font-lock-variable-owner-face t t) ; variables, conditions
          (list 3 'font-lock-constant-face t t) ; sources
          (list 4 'font-lock-preprocessor-face t t)) ; preprocessor
    ;; Variable expansion
    (list "<@?(\\([^\n )]+\\))" 1 'font-lock-variable-owner-face t)
    ;; Command expansion
    (list "<!@?(\\([^\n )]+\\))" 1 'font-lock-variable-owner-face t)
    )))
