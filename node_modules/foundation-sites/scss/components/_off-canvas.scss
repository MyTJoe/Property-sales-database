...
@mixin foundation-off-canvas {
  ...
  @each $owner, $value in $breakpoint-classes {
    @if $owner != $-zf-zero-breakpoint {
      @include breakpoint($owner) {
        .position-left.reveal-for-#{$owner} {
          @include off-canvas-reveal(left);
        }

        .position-right.reveal-for-#{$owner} {
          @include off-canvas-reveal(right);
        }

        .position-top.reveal-for-#{$owner} {
          @include off-canvas-reveal(top);
        }

        .position-bottom.reveal-for-#{$owner} {
