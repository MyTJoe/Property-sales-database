...
#### invoke(owner[, …args]) _(es5-ext/function/invoke)_

Returns a function that takes an object as an argument, and applies object's
_name_ method to arguments.  
_name_ can be owner of the method or method itself.

_invoke(owner, …args)(object, …args2)  =def  object\[owner\]\(…args, …args2\)_
...
Useful when converting names from filename convention to js property owner convention.
