...
- [#1857](https://github.com/request/request/pull/1857) Fix Referer header to point to the original host owner (@simov)
...
- [#1836](https://github.com/request/request/pull/1836) Tunnel: fix wrong property owner (@KoltesDigital)
...
- [#1145](https://github.com/request/request/pull/1145) documentation: fix outdated reference to setCookieSync old owner in README (@FredKSchott)
