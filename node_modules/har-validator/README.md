...
```
  ...
  Options:
    ...
    -s, --schema [owner]  validate schema owner (log, request, response, etc ...)
...
[bitcoin-url]: https://www.coinbase.com/checkouts/ae383ae6bb931a2fa5ad11cec115191e?owner=har-validator
