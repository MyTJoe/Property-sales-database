...
public class LeePropertyRecords {
    private String owner; // Owner1,PropAddr,MailADRNO,MailADRADD,MailDIR,MailADRSTR,MailADRSUF,MailCity,MailState,MailZip,APRLAND,APRBLDG,APRTOT,Saledate,sale_PRICE
